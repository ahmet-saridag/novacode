const techStack = [
  ...
  {
    category: "Cloud",
    techs: ["AWS", "Azure", "Google Cloud", "Cloudflare"],
  ...
  {
    category: "Yapay Zeka",
    techs: ["OpenAI", "TensorFlow", "PyTorch", "LangChain"],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
          {techStack.map((stack) => (
            <div
              key={stack.category}
              className={`rounded-2xl bg-gradient-to-b ${stack.color} border ${stack.border} p-6 card-hover`}
            >
